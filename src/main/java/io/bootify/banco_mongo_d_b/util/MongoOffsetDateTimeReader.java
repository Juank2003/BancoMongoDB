package io.bootify.banco_mongo_d_b.util;

import static io.bootify.banco_mongo_d_b.util.MongoOffsetDateTimeWriter.DATE_FIELD;
import static io.bootify.banco_mongo_d_b.util.MongoOffsetDateTimeWriter.OFFSET_FIELD;
