...
import io.bootify.banco_mongo_d_b.util.MongoOffsetDateTimeReader;
import io.bootify.banco_mongo_d_b.util.MongoOffsetDateTimeWriter;
...
@Configuration
@EnableMongoRepositories("io.bootify.banco_mongo_d_b.repos")
